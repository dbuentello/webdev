...
getUTF8String:function(offset, length){
...
getLong32:function(byteOffset){
     var i1 = this._getUint32(byteOffset);
     var i2 = this._getUint32(byteOffset);
     var num = (i1 * 4294967296) + i2; 
     return num;
} ,
